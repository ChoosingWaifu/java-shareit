...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> add(Long userId, ItemValidateDto itemDto) {
        return post("", userId, itemDto);
    }

    public ResponseEntity<Object> postComment(Long userId, Long itemId, CommentValidateDto commentDto) {
        return post(String.format("/%d/comment", itemId), userId, commentDto);
    }

    public ResponseEntity<Object> patch(Long userId, Long itemId, ItemValidateDto itemDto) {
